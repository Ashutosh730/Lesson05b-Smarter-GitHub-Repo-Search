        ...
        public Loader<String> onCreateLoader(int i, final Bundle bundle) {
            ...
            return new AsyncTaskLoader<String>(this) {
                ...
                protected String onLoadInBackground() {
                    String searchQrlQuery=bundle.getString(SEARCH_QUERY_URL_EXTRA);
                    if(searchQrlQuery==null|| TextUtils.isEmpty(searchQrlQuery))
                        return null;


                    String githubSearchResults = null;
                    try {
                        URL searchUrl=new URL(searchQrlQuery);
