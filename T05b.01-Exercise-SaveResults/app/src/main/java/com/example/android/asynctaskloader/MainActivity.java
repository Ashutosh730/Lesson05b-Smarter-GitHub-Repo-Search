...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RESULT_RAW_JSON="result";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState!=null){
            ...
            mSearchResultsTextView.setText(query);
            String result=savedInstanceState.getString(SEARCH_RESULT_RAW_JSON);
